# -*- coding: utf-8 -*-
#
# uitools documentation build configuration file, created by
...
latex_documents = [
  ('index', 'uitools.tex', u'uitools Documentation',
   u'Western X', 'manual'),
]
...
man_pages = [
    ('index', 'uitools', u'uitools Documentation',
     [u'Western X'], 1)
]
...
texinfo_documents = [
  ('index', 'uitools', u'uitools Documentation',
   u'Western X', 'uitools', 'One line description of project.',
   'Miscellaneous'),
]
